...
import goldadminpic from "../Photos/goldadmin.jpeg"
...
<option value="">JEWELLERY TYPE</option>
  <option value="G-ring/goldringorder">Gold Ring</option>
  <option value="G-bridalset/goldbridalorder">Bridal Set</option>
  <option value="G-earring/goldearringsorder">Ear Ring</option>
  <option value="G-pandelset/goldpandelsetorder">Pandel Set</option>
  <option value="G-bangles/goldbanglesorder">Gold Bangles</option>
  <option value="G-chain/goldchainorder">Gold Chain</option>
</select>
        </div> 
...
<option >Model No</option>
  <option value="YJ-GR">Gold Ring</option>
  <option value="YJ-GBS">Bridal Set</option>
  <option value="YJ-GER">Ear Ring</option>
  <option value="YJ-GPS">Pandel Set</option>
  <option value="YJ-GB">Gold Bangles</option>
  <option value="YJ-GC">Gold Chain</option>
</select>
        </div>
</div>  
...
<option >Gold Purity</option>
  <option value="GOLD-14K-585">GOLD-14K-585</option>
  <option value="GOLD-18K-750">GOLD-18K-750</option>
  <option value="GOLD-20k-833">GOLD-20k-833</option>
  <option value="GOLD-22k-916">GOLD-22k-916</option>
  <option value="GOLD-24k-999">GOLD-24k-999</option>
</select>
          <br/>
          <br/>
