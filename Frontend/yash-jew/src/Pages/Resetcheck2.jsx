...
import sendotp from "../Photos/resetpic2.jpg"
...
const isAuth = useSelector(state=>state.ResetReducer1.isAuth)
const Otpstatus = useSelector(state=>state.ResetReducer1.otpstatus)
  ...
  const HandleOnchange=(e)=>{
    ...
    const Handlesubmit=(e)=>{
     ...
     axios.post(`${process.env.React_App_Resetcheck2}`,payload)
       .then((res)=>{
      
      let Responsefromdb = res.data
      console.log(Responsefromdb);
      if(Responsefromdb==="Otp send Successfully"){
       alert("OTP send Successfully ON E-MAIL")
     navigate(`/resetcheck3/${useremails}`)
  ...
  return (
    ...
    <div className='mt-6'>
      ...
      <div className=" h-full mt-10  font-serif text-transparent  text-2xl   md:text-4xl lg:text-6xl bg-clip-text bg-gradient-to-r from-yellow-300 to-pink-800" >
      🏝️ Get Your OTP On Email..🏝️
      </div>
        ...
        <div className=' mt-10  w-[70%] m-auto   grid grid-cols-1 md:grid-cols-2 h-[500px]  gap-2  mb-[300px] sm:mb-[500px]  md:mb-[100px] ' >
            {/* div 1 */}
        <div    >
< img src={sendotp} className=' h-[30opx] w-full md:h-[300px] lg:w-[80%]  m-auto lg:h-[400px] mt-2 rounded-2xl' alt="avatar" />
        </div>
{/* div 2 form */}
        <div >
