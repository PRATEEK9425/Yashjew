...
navigate("/admin_goldproductlist")
}
const {GoldImg,Title,Category,Model_No,Availability_Type,Quantity,Gold_Karat} =formdata
  return (
    <div>
     ...
     <br/>
     <label className='font-bold text-lg text-teal-600 '>Purity 🧞‍♂️</label>
     <br/>
