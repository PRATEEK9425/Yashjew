...
const  GSEditorder = () => {
  ...
  const Getdata = ()=>{
    axios.get(`${process.env.React_App_GSEditorder_url1}/${id}`)
    .then((res)=>{
  ...
  const Handlechange=(e)=>{
    ...
    axios.patch(`${process.env.React_App_GSEditorder_url2}/${id}`,payload)
    .then((res)=>{
    ...
    navigate("/admin/web-GS-orderList")
    }
console.log(formdata);
  ...
  <br/>
     ...
     <br/>
     <label className='text-xl font-bold text-fuchsia-600 '  htmlFor="">Gold Karat</label>
  <br/>
     <input name="Gold_Karat" defaultValue={Gold_Karat} onChange={Handlechange}  required  placeholder='Gold Karat 🤴'  className={styles.textbox} type="string"  />
     <br/>
